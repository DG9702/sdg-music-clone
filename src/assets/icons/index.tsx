...
export function LibraryCollapseIcon() {
    return (
        <svg
            data-encore-id='icon'
            role='img'
...
export function SaveTrack(props: Partial<IconProps>) {
    const { size = 32 } = props;
    return (
        <svg
            data-encore-id="icon"
...
export function UserSavedTrack(props: Partial<IconProps>) {
    const { size = 32 } = props;
    return (
        <svg
            data-encore-id="icon"
...
export const AddToQueueIcon = (props: Partial<IconProps>) => {
    const { size = 32 } = props;
    return (
        <svg
            data-encore-id="icon"
...
export const ArtistIcon = (props: Partial<IconProps>) => {
    const { size = 32 } = props;
    return (
        <svg
            data-encore-id="icon"
...
export const AlbumIcon = (props: Partial<IconProps>) => {
    const { size = 32 } = props;
...
export const OrderListIcon = (props: Partial<IconProps>) => {
    const { size = 32 } = props;
...
export const GridIcon=(props: Partial<IconProps>) => {
    const { size = 32 } = props;
...
export const OrderCompactIcon = (props: Partial<IconProps>) => {
    const { size = 32 } = props;
...
export function EpisodesIcon(props: Partial<IconProps>) {
    const { size = 64 } = props;
    return (
        <svg
            data-encore-id="icon"
            ...
            viewBox="0 0 24 24"
        >
            <path d="M7 1a3 3 0 0 0-3 3v17.167c0 1.448 1.657 2.27 2.81 1.393L12 18.612l5.19 3.948c1.153.876 2.81.055 2.81-1.393V4a3 3 0 0 0-3-3H7z">
...
export const NewPlaylistIcon=(props: Partial<IconProps>) => {
  const {size=16}=props;
  return (
    <svg
      data-encore-id='icon'
